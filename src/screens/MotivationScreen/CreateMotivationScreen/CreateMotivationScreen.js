...
const CreateMotivationScreen = () => {
  ...
  const handleAddMotivation = () => {
    ...
    setMotivations([
      ...motivations,
      { text: motivationText, author: motivationAuthor },
    ]);
      ...
      <View style={styles.root}>
        ...
        >
          <TextInput
            ...
            onChangeText={(text) => setMotivationText(text)}
            style={styles.input}
          />
          ...
          <TextInput
            ...
            onChangeText={(text) => setMotivationAuthor(text)}
            style={styles.input}
          />

          <CustomButton
            text='Save New Motivation'
            onPress={handleAddMotivation}
            type='PRIMARY'
          />

          <CustomButton
            text='Motivation Entries'
            onPress={onMotivationContainerPressed}
            type='SECONDARY'
          />
        </KeyboardAvoidingView>
      </View>
